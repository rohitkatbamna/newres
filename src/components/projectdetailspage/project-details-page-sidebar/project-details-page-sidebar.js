...
function Projectsidebar(){
    return(
        ...
        <div style={{borderRadius:'none',fontFamily:'Roboto, sans-serif'}}>
            <div>
                <div className="card shadow" style={{width:'200px',height:'1920px',backgroundColor:"#000000"}}>
                    <div className="card-body position-fixed" style={{backgroundColor:"#000000",width:'200px',color:'white',height:'1920px'}}>
                        <div>
